  ...
  \chapter{Curva caracteristica del Diodo}
    ...
    \section{Polarizacion en directa}
      ...
      \subsection{Diodo de Germanio}
        Para corroborar la curva caracteristica del diodo de germanio, y como esta responde a los cambios de voltaje y
        temperatura, nuevamente se creo un circuito en el software LTSpice muy basico para probar la polarizacion del 
        diodo de germanio. El programa, realiza el mismo barrido que para el circuito del diodo de silicio con la misma
        resolucion.
        ...
        Habiendo simulado el circuito anterior, se extrayeron los resultados para ser mostrados en la figura
        (\ref{graph.simulation.Ge.directa}).
        ...
        \begin{figure}[H]
          ...
          \hfill
          \begin{minipage}{0.45\textwidth}
            \includegraphics[width=1\textwidth]{pictures/Curva_Datash_Ge.png}
            \caption{Grafico de la curva caracteristica de la hoja de datos.}
    ...
    \section{Polarizacion en inversa}
      ...
      \subsection{Diodo de Germanio}
        ...
        \begin{figure}[!h]
          \centering
          \begin{minipage}[b]{0.4\textwidth}
            \includegraphics[width=1.1\linewidth]{pictures/Curva_Datash_Ge.png}
