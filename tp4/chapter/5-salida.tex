...
\section{Actividad de Laboratorio}
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}
        ...
        (0,0) (1,0.84) (2,0.98) (3,1.1) (4,1.14) (5,1.31) (6,1.39) (7,1.47) (8,1.59) (9,1.64) (10,1.72)
        };
        \addlegendentry{$V_{GS}=0$ V}
        
        \addplot+[mark=square*] coordinates {
        (0,0) (1,0.32) (2,0.39) (3,0.46) (4,0.52) (5,0.57) (6,0.62) (7,0.67) (8,0.73) (9,0.77) (10,0.83)
        };
        \addlegendentry{$V_{GS}=-0.1$ V}
        
        \addplot+[mark=triangle*] coordinates {
        (0,0) (1,0.05) (2,0.07) (3,0.09) (4,0.12) (5,0.137) (6,0.155) (7,0.172) (8,0.146) (9,0.211) (10,0.212)
        };
        \addlegendentry{$V_{GS}=-0.2$ V}
        
        \addplot+[mark=diamond*] coordinates {
        (0,0) (1,2.6) (2,4.3) (3,6.1) (4,8.5) (5,10.1) (6,12.3) (7,15.5) (8,18.3) (9,21.5) (10,25.5)
        };
        \addlegendentry{$V_{GS}=-0.3$ V}
        
        \end{axis}
      \end{tikzpicture}
      \caption{$I_{D}$ en función de $V_{DS}$ para distintos valores de $V_{GS}$.}
    \end{figure}
